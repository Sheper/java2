package com.pp.hibernate.crud.operations;
...
public class DbOperations {
	...
	public static void createRecord() {
		...
		try {
			...
			for(int j = 101; j <= 105; j++) {
				...
				studentObj.setNombre("hibernate "+j);
				studentObj.setPassword("hibernate"+j);
				studentObj.setEmail("@hibernate");
				studentObj.setSexo("tecnologia");
				studentObj.setPais("nones");	
	...
	public static void updateRecord(int student_id) {		
		try {
			...
			stuObj.setNombre("UPDATE hibernate ");
			stuObj.setPassword("UPDATE hibernate");
			stuObj.setEmail("UPDATE @hibernate");
			stuObj.setSexo("UPDATE tecnologia");
			stuObj.setPais("UPDATE nones");
